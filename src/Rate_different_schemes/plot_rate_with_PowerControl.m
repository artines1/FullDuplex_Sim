...
legend('1db Perfect',...
    ...
    'Location','NorthWest');
grid on
saveas(f1,'rate_DU_with_PowerControl_sumv3_Fair','fig');
saveas(f1,'rate_DU_with_PowerControl_sumv3_Fair','jpg');
...
legend('1db Perfect',...
    ...
    'Location','NorthWest');
grid on
saveas(f2,'rate_DU_with_PowerControl_upv3_Fair','fig');
saveas(f2,'rate_DU_with_PowerControl_upv3_Fair','jpg');
...
legend('1db Perfect',...
    ...
    'Location','NorthWest');
grid on
saveas(f3,'rate_DU_with_PowerControl_downv3_Fair','fig');
saveas(f3,'rate_DU_with_PowerControl_downv3_Fair','jpg');
...
legend('1db Perfect UnFair',...
    ...
    'Location','NorthWest');
grid on
saveas(f4,'rate_DU_with_PowerControl_sumv3_UnFair','fig');
saveas(f4,'rate_DU_with_PowerControl_sumv3_UnFair','jpg');
...
legend('1db Perfect UnFair',...
    ...
    'Location','NorthWest');
grid on
saveas(f5,'rate_DU_with_PowerControl_upv3_UnFair','fig');
saveas(f5,'rate_DU_with_PowerControl_upv3_UnFair','jpg');
...
legend('1db Perfect UnFair',...
    ...
    'Location','NorthWest');
grid on
saveas(f6,'rate_DU_with_PowerControl_downv3_UnFair','fig');
saveas(f6,'rate_DU_with_PowerControl_downv3_UnFair','jpg');
%{
f4=figure;
