...
for exper_idx=1:experiment_number
    ...
    f7=figure;
    plot(x,ave_rate_UD_with_channelgain(:,1),'o-k',...
        x,ave_rate_UD_with_channelgain(:,13),'x-k',...
        x,ave_rate_UD_with_channelgain(:,16),'hexagram-k',...
        x,ave_rate_UD_with_channelgain(:,19),'^--r',...
        'MarkerSize', 10, 'linewidth', 1.5);
    set(gca,'FontSize',12)
    xlabel(Profiles(exper_idx, 1).graph_X_axis_title);
    ylabel(Profiles(exper_idx, 1).graph_Y_axis_title);
    %axis([x(1,1),x(1,end),0,15]);
    legend('Interference Avoidance',...       
        'Sum Rate Maximization',...
        'Half-Duplex',...
        'FDMAC',...
        'Location','NorthWest');
    grid on
    figure_savepath=strcat(Profiles(exper_idx, 1).log_path, 'rate_DU_with_PowerControl_Sum');    
    saveas(f7,figure_savepath,'fig');
    saveas(f7,figure_savepath,'jpg');
    
    f8=figure;
    plot(x,ave_rate_UD_with_channelgain(:,2),'o-k',...
        x,ave_rate_UD_with_channelgain(:,14),'x-k',...
        x,ave_rate_UD_with_channelgain(:,17),'hexagram-k',...
        x,ave_rate_UD_with_channelgain(:,20),'^--r',...
        'MarkerSize', 10, 'linewidth', 1.5);
    set(gca,'FontSize',12)
    xlabel(Profiles(exper_idx, 1).graph_X_axis_title);
    ylabel(Profiles(exper_idx, 1).graph_Y_axis_title);
    ...
    legend('Interference Avoidance',...       
        ...
        'Location','NorthWest');
    grid on
    figure_savepath=strcat(Profiles(exper_idx, 1).log_path, 'rate_DU_with_PowerControl_Up');    
    saveas(f8,figure_savepath,'fig');
    saveas(f8,figure_savepath,'jpg');
    
    f9=figure;
    plot(x,ave_rate_UD_with_channelgain(:,3),'o-k',...
        x,ave_rate_UD_with_channelgain(:,15),'x-k',...
        x,ave_rate_UD_with_channelgain(:,18),'hexagram-k',...
        x,ave_rate_UD_with_channelgain(:,21),'^--r',...
        'MarkerSize', 10, 'linewidth', 1.5);
    set(gca,'FontSize',12)
    xlabel(Profiles(exper_idx, 1).graph_X_axis_title);
    ylabel(Profiles(exper_idx, 1).graph_Y_axis_title);
    ...
    legend('Interference Avoidance',...       
        ...
        'Location','NorthWest');
    grid on
    figure_savepath=strcat(Profiles(exper_idx, 1).log_path, 'rate_DU_with_PowerControl_Down');    
    saveas(f9,figure_savepath,'fig');
    saveas(f9,figure_savepath,'jpg');
