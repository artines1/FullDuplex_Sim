function [transmission_second ]=fcn_MAC_DU(transmission_first,traffic_reg_second,num_up_STA,channel_gain,channel_gain_withAP,power_transmit_AP,power_transmit_STA)
...
% For every station B, it calculate its interference ratio
for i=1:num_up_STA
